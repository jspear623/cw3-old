public class TestFunctionalLinkedList extends TestLinkedList {
	FunctionalLinkedList testList;
	ReturnObject result;
	public TestFunctionalLinkedList() {
		//Constructor
		this.testList = new FunctionalLinkedList();
		this.result = new ReturnObjectImpl();
	}
	
	public static void main(String[] args) {
		TestFunctionalLinkedList tester = new TestFunctionalLinkedList();
		tester.launch();

	}
	public void launch() {
		System.out.println("I have created a new FunctionalLinkedList which is empty.\n");
